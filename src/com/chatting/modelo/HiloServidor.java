...
/**
 * Hilo del servidor que tratara al cliente.
 * 
 *
 */
public class HiloServidor extends Thread {
	...
	public void run() {
		...
		try {
			...
			Servidor.imprimirTodos("<SERVER> "+nombre+" se ha caido (connection timeout).");
	...
	/**
	 * Aqui tratamos los mensajes que le lleguen al server.
	 * @param mensaje
	 */
	...
	/**
	 * Lo que hacemos cuando un cliente envia el codigo de cambio de nick.
	 */
	...
	/**
	 * Aqui inicializamos el cliente (darle nombre y meterlo en listaClientes)
	 */
	...
	/**
	 * Modifica el nombre que recibe para que no esta repetido en la lista de clientes.
	 * @param nombreViejo
	 * @return
	 */
	private String nombreNoRepetido(String nombreViejo) {
		// Si ya existe un cliente que se llame asi, lo renombramos
