...
/**
 * Clase que almacena los clientes que estan conectados.
...
public class ListaClientes {
	...
	/**
	 * Envia a todos los clientes actualización de número de clientes conectados.
	 */
	...
	/**
	 * Recorremos todos los clientes enviandoles el mensaje
	 * @param msg
	 */
	...
	public void emitirA(String msg, String destino) {
		Set<Map.Entry<String, HiloServidor>> set = mapaClientes.entrySet();
		for (@SuppressWarnings("rawtypes") Entry entry : set) {
